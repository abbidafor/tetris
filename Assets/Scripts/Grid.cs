...
// This class handles all the logic about deleting rows when a user 
...
public class Grid : MonoBehaviour
{
    ...
    // chck if some vector is inside the limits of game (borders left, right and down)
    ...
    // whenever a row is deleted, all the above rows should be decreased by 1
